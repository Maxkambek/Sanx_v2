...
class TransportInformation(models.Model):
    ...
    driver_license_back = models.FileField(upload_to='driver_license/', null=True)
    driver_license_with_face = models.FileField(upload_to='driver_license/', null=True)
    driver_license_seria_number = models.CharField(max_length=123,null=True, blank=True)
    driver_license_expiration = models.CharField(max_length=123,null=True, blank=True)
    car_gos_number = models.CharField(max_length=123,null=True)
    trailer_gos_number = models.CharField(max_length=123,null=True)
    tex_passport = models.FileField(upload_to='files/', null=True)
    tex_passport_back = models.FileField(upload_to='files/', null=True)
    trailer_passport = models.FileField(upload_to='files/', null=True)
    trailer_passport_back = models.FileField(upload_to='files/', null=True)
